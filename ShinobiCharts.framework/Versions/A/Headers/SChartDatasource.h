...
/** Return a float as the radius of a data point
 ...
 If this method is implemented and a non-zero, positive radius is returned for a data point in a series, that radius will be used for the data point. */
- (float)sChartRadiusForDataPoint:(ShinobiChart*)chart dataPointAtIndex:(int)dataIndex forSeriesAtIndex:(int)seriesIndex;

/** Return a float as the inner radius of a data point
 
 If this method is implemented and a non-zero, positive radius is returned for a data point in a series, that inner radius will be used for the data point. */
