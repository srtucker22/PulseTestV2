...
/** The UIColor of the inner sections of data points */
@property (nonatomic, retain)     UIColor   *innerColor;

/** The UIColor of the inner sections of data points below the baseline */
@property (nonatomic, retain)     UIColor   *innerColorBelowBaseline;

/** The radius of the default data point */
@property (nonatomic, retain)     NSNumber  *radius;

/** The inner radius of the default data point */
